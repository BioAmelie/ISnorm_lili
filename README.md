...
We will use one dataset from [Klein *et al.*](https://linkinghub.elsevier.com/retrieve/pii/S0092867415005000) as example, which is available at GEO database [GSE65525](http://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE65525). The file `GSM1599494_ES_d0_main.csv` contains scRNA-seq data of 933 mouse embryonic stem cells. You should also put it into your work directory to run the scripts below.

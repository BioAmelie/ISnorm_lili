...
In few cases the results of ISnorm may be sensitive to the value of `baseline_threshold` (e.g. using `baseline_threshold=0.15` will generate fairly different results, see our article for more details). This suggests that there may be few constantly expressed genes in the dataset. When encountered with this problem, the results of ISnorm are not strongly supported. 
